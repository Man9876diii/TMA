...
//  CNPPopupController
//
//  Created by Landon Ferrier on 1/8/18.
//  Copyright (c) 2018 Landon Ferrier. All rights reserved.
//
...
- (instancetype)initWithContents:(NSArray <UIView *> *)contents {
    ...
    if (self) {
        ...
        self.popupView.backgroundColor = [UIColor colorWithRed:211/255.0 green:189/255.0 blue:3/255.0 alpha:1];
